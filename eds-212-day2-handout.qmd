...
```{r}
ggplot(data = penguins, aes(x = penguins$species, y = penguins$flipper_length_mm)) + geom_jitter() + labs(x = "Penguin Species", y = "Flipper Length in MM", title = "Penguin Flipper Size by Species")
```
